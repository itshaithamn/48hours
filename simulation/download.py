...
if __name__ == "__main__":
    ...
    print(f"User: saved_user_files_list: {userid}, Filename: {saved_user_files_list[0][0]}, Filepath: {saved_user_files_list[0][1]}, File Date: {saved_user_files_list[0][2]}, File Size: {saved_user_files_list[0][3]}")
